...
namespace DS
{
	public static class Lyapunov
	{
		...
		public static IEnumerable<(double D12, double D21, double L1, double L2)> GetIndicators(Model model, PointX start,
			...
			double d12End, double d21End, double step1, double step2, double eps = 0.00001, double t = 100000)
		{
			...
			for (var i = 0; i < processorCount; i++)
			{
				...
				tasks[i] = Task.Run(() => GetIndicators(copy, start, d12PartEnd, d21End, step1, step2, false, eps, t));
			}
